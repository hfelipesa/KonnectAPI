...
public class Afiliado {
    ...
    //zona datos (atributos de la clase
    ...
    private ValidacionAfiliado validacion=new ValidacionAfiliado();

    public Afiliado() { //construtor vacio
    }
